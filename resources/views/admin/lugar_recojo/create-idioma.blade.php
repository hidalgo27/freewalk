...
@endsection
@section('content')
<form action="{{ route('admin.lugar-recojo.index.idioma.store.path',[$lugar_recojo->id,$idioma_->codigo,$arreglo]) }}" method="post" enctype="multipart/form-data">
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-row">
                ...
                <div class="form-group col-12">
                    ...
                    <input type="file" class="form-control" id="referencia_imagen_mapa" name="referencia_imagen_mapa" placeholder="Imagen del mapa" >
                </div>
            </div>
        </div>
