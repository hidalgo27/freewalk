  ...
  <div id="form"  class="result mt-2">
    <div class="box-form border rounded shadow bg-white">
      ...
      <div class="form-group">
              <p>Date: <input class="form-control form-control-sm" type="text" id="datepicker2" name="date1"></p>
       </div>
      ...
      <div class="form-group">
        ...
        <select class="form-control form-control-sm" id="nombretour" name="nombretour1">
             <option value="" disabled selected>Choose your free tour departure</option>
              <option value="barranco-4pm">Free Tour Barranco 4pm(Pickup)</option>
              <option value="barranco-4:40pm">Free Tour Barranco 4:40pm</option>
        </select>
      </div>
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="form-group text-center">
          <button type="submit" class="btn btn-send btn-lg px-5 w-100">Book Now</button>
          <small><font color="red">¡Please! Before Booking Double Check The Confirmed Departures For Miraflores Free Tour, If No Confirmed Departures Do Not Book Yet!</font></small>
        </div>
